...
public class ParkingSpotService {
    ...
    public Optional<ParkingSpotModel> getModelId(UUID id){
        return parkingSpotRepository.findById(id);    //get tira de dentro do Optional
    }
    ...
    public ParkingSpotModel searchForName(String name){
